...
{
    [Serializable]
    public class cBP3Layer<T> : iBackPropagation<T> where T : IComparable<T>
    {
        ...
        public cBP3Layer(int preInputNum, int inputNum, int hiddenNum, int outputNum, double lr)
        {
            ...
            try
            {
                for (i = 0; i < PreInputNum; i++)
                {
                    ...
                    for (j = 0; j < InputNum; j++)
                    {
                        ...
                        PreInputLayer[i].Weights[j] = 0.3 + ((double)rand.Next(0, 8) / 100);
                    }
                }
                ...
                for (i = 0; i < InputNum; i++)
                {
                    ...
                    for (j = 0; j < HiddenNum; j++)
                    {
                        ...
                        InputLayer[i].Weights[j] = 0.3 + ((double)rand.Next(0, 8) / 100);
                    }
                }
                ...
                for (i = 0; i < HiddenNum; i++)
                {
                    ...
                    for (j = 0; j < OutputNum; j++)
                    {
                        ...
                        HiddenLayer[i].Weights[j] = 0.3 + ((double)rand.Next(0, 8) / 100);
                    }
                }
